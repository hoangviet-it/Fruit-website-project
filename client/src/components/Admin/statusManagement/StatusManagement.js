...
return (
    <>
        <div className="title-line-create-pro-ad">
            <div className="item-tt-line-cre-pro-ad item-ttline-update-pro-ad">QUẢN LÝ TRẠNG THÁI</div>
        </div>
            ...
            <div className="element-status-pro container-category-mana-ad" style={!move?{display:'flex'}:{display:'none'}}>
                ...
                <div className="form-create-cate-ad">
                    ...
                    {   
                        ...
                        status_pros.map(pro=>{
                            if(pro._id===idStatus){
                                return <p><span style={{fontWeight:'500', marginTop:'10px', display:'inline-block'}}>Tên trạng thái: </span> &nbsp;{pro.name}</p>
                            }
                        }):''
                    }
